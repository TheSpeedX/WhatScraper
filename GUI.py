...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"WhatScraper GUI", pos = wx.DefaultPosition, size = wx.Size( 500,300 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.TitleText = wx.StaticText( self, wx.ID_ANY, u"WhatScraper", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.TitleText.Wrap( -1 )

		self.TitleText.SetFont( wx.Font( 14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Arial" ) )

		HeaderSizer.Add( self.TitleText, 0, wx.ALL, 5 )

		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"Scrape indefinitely", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText2.Wrap( -1 )

		HeaderSizer.Add( self.m_staticText2, 0, wx.TOP|wx.BOTTOM|wx.RIGHT, 15 )
		...
		CategorySizer = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Scrape Origin" ), wx.VERTICAL )

		self.radio_Google = wx.RadioButton( CategorySizer.GetStaticBox(), wx.ID_ANY, u"From Google Search", wx.DefaultPosition, wx.DefaultSize, 0 )
		CategorySizer.Add( self.radio_Google, 0, wx.ALL, 5 )

		self.radio_ListSite = wx.RadioButton( CategorySizer.GetStaticBox(), wx.ID_ANY, u"Group Sharing Sites", wx.DefaultPosition, wx.DefaultSize, 0 )
		CategorySizer.Add( self.radio_ListSite, 0, wx.ALL, 5 )

		self.radio_CheckFile = wx.RadioButton( CategorySizer.GetStaticBox(), wx.ID_ANY, u"From File", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.radio_CheckFile.Enable( False )

		CategorySizer.Add( self.radio_CheckFile, 0, wx.ALL, 5 )


		ScraperMenuSizer.Add( CategorySizer, 1, wx.ALIGN_TOP|wx.EXPAND|wx.LEFT|wx.RIGHT, 10 )

		self.ScraperScrollWindow = wx.ScrolledWindow( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.HSCROLL|wx.VSCROLL )
		self.ScraperScrollWindow.SetScrollRate( 5, 5 )
		MainScraperSizer = wx.BoxSizer( wx.VERTICAL )

		self.button_StartScraper = wx.Button( self.ScraperScrollWindow, wx.ID_ANY, u"Start Scraper", wx.DefaultPosition, wx.DefaultSize, 0 )
		MainScraperSizer.Add( self.button_StartScraper, 0, wx.ALL, 5 )

		self.ScrapedList = wx.ListCtrl( self.ScraperScrollWindow, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_REPORT )
		...
		ScraperMenuSizer.Add( self.ScraperScrollWindow, 3, wx.EXPAND |wx.ALL, 5 )
